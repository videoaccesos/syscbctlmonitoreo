...
class RegistrosAccesos_Model extends CI_model
{
	...
	public function enviar_notificaciones_emails($id){
		$result = null;
		//Datos del Acceso
		$this->db->select("DATE_FORMAT( DATE_ADD(RA.fecha_modificacion, INTERVAL -1 HOUR ),'%d-%m-%Y') AS fecha, DATE_FORMAT( DATE_ADD(RA.fecha_modificacion, INTERVAL -1 HOUR ),'%r') AS hora,P.descripcion AS privada, R.nro_casa, R.calle, 
