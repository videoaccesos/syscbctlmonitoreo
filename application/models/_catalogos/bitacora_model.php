...
class Bitacora_Model extends CI_model
{
	...
	public function filtro($id = null, $strTabla = null, $intNumRows, $intPos){
		$this->db->select("U.usuario, CONCAT(E.nombre,' ',E.ape_paterno,' ',E.ape_materno) AS empleado ,DATE_FORMAT( DATE_ADD(BM.fecha_modificacion, INTERVAL -1 HOUR ),'%d-%m-%Y %h:%i %p') AS fecha",FALSE);
