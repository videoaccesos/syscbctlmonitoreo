...
class Privadas_Model extends CI_model
{
	public function guardar($strDescripcion,$strApePaterno,$strApeMaterno,$strNombre,$intTipoContactoID,
		                    $strTelefono,$strCelular,$strEmail,$strHistorial,$strFechaVence,$strObservaciones,
                            $strDNS1,$strPuerto1,$strAlias1,$strDNS2,$strPuerto2,$strAlias2,$strDNS3,$strPuerto3,
                            $strAlias3, $strVideo1,$strAliasVideo1,$strVideo2,$strAliasVideo2,$strVideo3,
	...
	public function modificar($intPrivadaID,$strDescripcion,$strApePaterno,$strApeMaterno,$strNombre,
		                      $intTipoContactoID,$strTelefono,$strCelular,$strEmail,$strHistorial,$strFechaVence,$strObservaciones,
		                      $strDNS1,$strPuerto1,$strAlias1,$strDNS2,$strPuerto2,$strAlias2,$strDNS3,$strPuerto3,$strAlias3,
    ...
    public function modificarDNSS($intPrivadaID,$intDNSID,$strDNS,$strPuerto,$strAlias){	
