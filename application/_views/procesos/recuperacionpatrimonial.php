<form id="frmRecuperacionPatrimonial" action="#" method="post" onsubmit="return(false)" style="margin-bottom:50px;">
          ...
          <div>
            <div style="display:inline-block; padding-right:17px;">
                ...
                <select id="cmbPrivadaID" style="width:460px;" tabindex="6"> </select>
					...
					<div>
						<div style="display:inline-block;">
						  <label for="txtNombreResponsable">Datos del Responsable</label>
						  <input class="span6" id="txtNombreResponsable" type="text" placeholder="Nombre" tabindex="8" maxlength="80">
						  <input class="span6" id="txtDomicilioResponsable" type="text" placeholder="Domicilio" tabindex="9">
						</div>
					</div>

					<div>
					  <div style="display:inline-block; padding-right:17px;">
						<input class="span3" id="txtTelefonoResponsable" type="text" placeholder="Teléfono" tabindex="10" maxlength="14">
					  </div>
					  <div style="display:inline-block;">
						<input class="span3" id="txtCelularResponsable" type="text" placeholder="Celular" tabindex="11" maxlength="14">
					  </div>
					</div> 
					<div>
					  <input class="span3" id="txtRelacionResponsable" type="text" placeholder="Relación" tabindex="12" maxlength="40">
					</div>
				</div>
          ...
          <div class="btn-group" style="float:right;padding-right:17px;padding-top:20px;">
              ...
              <a href="#myModal" type="button" data-toggle="modal" class="btn btn-inverse" tabindex="30" onBlur="$('#txtFolio').focus();"><i class="icon-search icon-white"></i>  Buscar</a> 
					...
					<div style="padding-top:65px;">
						...
						<div style="display:inline-block; padding-right:17px;">
							<input class="span2" id="txtPlacas" type="text" placeholder="Placas" tabindex="13" maxlength="20">
						</div>
							<div style="display:inline-block; padding-right:17px;">
								<input class="span2" id="txtModelo" type="text" placeholder="Modelo" tabindex="14" maxlength="20">
							</div>
						<div style="display:inline-block;">
							<input class="span2" id="txtColor" type="text" placeholder="Color" tabindex="15" maxlength="20">
						</div>
					</div>
					<div>
						<div style="display:inline-block; padding-right:17px;">
							<input class="span4" id="txtMarca" type="text" placeholder="Marca o Tipo" tabindex="16" maxlength="20">
						</div>
					</div>
              ...
              <div>
                ...
                <div style="display:inline-block; padding-right:17px;">
                  <label for="txtFechaIni_Buscar">Fecha Inicial</label>
                   <div class="input-append datepicker">
                      <input id="txtFechaIni_Buscar" style="width:80px;" data-format="dd-MM-yyyy" type="text" tabindex="-1">
                      <span class="add-on">
                        <i data-time-icon="icon-time" data-date-icon="icon-calendar" class="icon-calendar"></i>
                      </span>
                   </div>  
                ...
                <div style="display:inline-block; padding-right:17px;">
                  <label for="txtFechaFin_Buscar">Fecha Final</label>
                   <div class="input-append datepicker">
                      <input id="txtFechaFin_Buscar" style="width:80px;" data-format="dd-MM-yyyy" type="text" tabindex="-1">
                      <span class="add-on">
                        <i data-time-icon="icon-time" data-date-icon="icon-calendar" class="icon-calendar"></i>
                      </span>
                   </div> 
                ...
                <div style="display:inline-block; padding-right:17px;">
                    ...
                    <select id="cmbEstatusID_Buscar" style="width:140px;" tabindex="3"> 
                ...
                <div style="display:inline-block; margin-top: -15px;"> 
                  <button type="button" class="btn" tabindex="9" onclick="paginacion();" style="margin-top:-7px;"> Buscar <i class="icon-search"></i></button>
                </div>
              </div>
            </div>
            <div style="width:100%; display:inline-block;">
...
function paginacion(varP) {
    ...
    if($('#txtNombre_Buscar').val()+$('#txtFechaIni_Buscar').val()+$('#txtFechaFin_Buscar').val()+$('#cmbEstatusID_Buscar').val() != strUltimaBusqueda){
      bolPagina = true;
      pagina = 0;
    }
    if(bolPagina)
    $.post('procesos/recuperacionpatrimonial/paginacion',
                 {strResponsable:$('#txtNombre_Buscar').val(),
                  ...
                  function(data) {
                    ...
                    pagina = data.pagina;
                    strUltimaBusqueda = $('#txtNombre_Buscar').val()+$('#txtFechaIni_Buscar').val()+$('#txtFechaFin_Buscar').val()+$('#cmbEstatusID_Buscar').val();
                    bolPagina = false;
                  }
                 ,
          'json');
