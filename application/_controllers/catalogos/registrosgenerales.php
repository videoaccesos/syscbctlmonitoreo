<?php 
class RegistrosGenerales extends MY_controller
	{
		var $bolAcceso = FALSE;
		var $data = NULL;
		...
		function __construct () {
	      parent::__construct ();
	      $this->data['strProceso'] = 'registrosgenerales';
	      $this->data['formulario'] = 'REGISTROS GENERALES';
	      $this->bolAcceso = $this->Acceso('RegistrosGenerales');
	      $this->load->model('catalogos/registrosgenerales_model','registrosgenerales');
	    }

		public function index(){
			if($this->bolAcceso)
				$this->data['contenido'] = $this->load->view("catalogos/registrosgenerales",NULL,TRUE);
			else
		...
		public function paginacion(){
			...
			$arr = array('rows' => $errorult['registros_generales'],
