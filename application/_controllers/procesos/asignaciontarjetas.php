<?php 
	class AsignacionTarjetas extends MY_controller
	{
		var $bolAcceso = FALSE;
		var $data = NULL;
		...
		function __construct () {
	      parent::__construct ();
	      $this->data['strProceso'] = 'asignacion_tarjetas';
	      $this->data['formulario'] = 'ASIGNACIÓN DE TARJETAS';
	      $this->bolAcceso = $this->Acceso('ASIGNACIÓN DE TARJETAS');
	      $this->load->model('procesos/asignaciontarjetas_model','asignacion_tarjetas');
	    }
		...
		public function index(){
			...
			if($this->bolAcceso)
				$this->data['contenido'] = $this->load->view("procesos/asignaciontarjetas",$this->data,TRUE);
			else
