...
class AsignacionTarjetas extends MY_controller
	{
		...
		function __construct () {
	      parent::__construct ();
	      $this->data['strProceso'] = 'asignaciontarjetas';
	      $this->data['formulario'] = 'ASIGNASION DE TARJETAS';
	      $this->bolAcceso = $this->Acceso('Asignacion de Tarjetas');
		...
		public function index(){
			...
			if($this->bolAcceso)
				$this->data['contenido'] = $this->load->view("reportes/asignaciontarjetas",$this->data,TRUE);
			else
