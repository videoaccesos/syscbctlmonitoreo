<?php 
	class OrdenesServicio extends MY_controller
	{
		...
		public function guardar() { 
			...
			$this->form_validation->set_rules('strFechaAsistio', 'Fecha de Asistencia', 'max_length[30]');
...
Asignado a: $res->tecnico
Detalle del Servicio : $res->detalle_servicio

Para cumplir el reporte ingresa al siguiente link http://www.videoaccesos.com/syscbctlmonitoreo/procesos/ordenesservicio
...
";
			...
			$this->email->subject('Orden de Servicio F:'.$res->folio.' '.$res->privada);
