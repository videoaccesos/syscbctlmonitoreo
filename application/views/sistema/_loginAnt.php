                    ...
                    <div class="row-fluid">
                            <form id="frmLogin" method="post"  action="#"  class="form-horizontal" onsubmit="return(false)"> 
                               ...
                               <div style="width:221px; text-align:left;">
                                    ...
                                    <button id="btnIngresar" onclick="fnVerificarExistenciaSesion()"  type="submit" class="btn" style="float:right;">Ingresar</button>
                                   <!-- <h1 id="list"></h1>-->
                                </div>
                            </form>
                    </div>
...
<script type="text/javascript">
  ...
  function  fnVerificarExistenciaSesion(){
      ...
      {
            $.post("<?php echo base_url()?>login/regresarIPAnterior",
                  { 
                  ...
                  function(data) {
                      ...
                      $('#txtFechaAnterior').val(data.inicio_sesion);
                          //Si la ip anterior es diferente de la ip actual, preguntar si quiere dar salida
                          if( strIPAnterior!='' && $('#txtListaIPs').val()!=strIPAnterior)
                          {   
