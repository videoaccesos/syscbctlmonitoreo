...
<form id="frmReporte" action="#" method="post" target="_blank" style="margin:0px;" accept-charset="ISO-8859-1">
    ...
    <!--<div class="input-append date datepicker">
      ...
      <div  style="display:inline-block; padding-right:17px;">
        <input type="hidden" id="txtEstado" name ="strEstatus">
        <label for="cmbEstadoID">Grafica</label>
          <select id="cmbGraficaID" name="intGraficaID" style="width:170px;"  tabindex="8">
      ...
      <div style="display:inline-block;padding-right:17px;">
        ...
        <input type="text" id="txtTitulo"style="width:250px;" tabindex="9">
      </div>
      <div style="display:inline-block;padding-right:17px;">
        <label for="txtIntervalo">Intervalo</label>
        <input type="text" id="txtIntervalo" style="width:40px;text-align:right;" tabindex="10" value="0" onBlur="fnFormato(this,0);">
        <input type="text" id="txtIntervaloMax" style="width:70px;text-align:right;" tabindex="11" value="0" onBlur="fnFormato(this,0);">
      </div>
      <div style="display:inline-block; padding-right:17px;">
        <button type="button" class="btn" tabindex="12" onClick="paginacion();" style="margin-top:-7px;"> Generar <i class="icon-refresh"></i></button>
      </div>
</form>
...
<script type="text/javascript">
  ...
  function paginacion() {
    ...
    if(bolPagina){
      ...
      //Si la descripción del solicitante esta vacia
                    ...
                    function(data) {
                      ...
                      if(data.length > 0){
                        ...
                        for(i = 0; i < data.length; i++) {
                          intTotalRegistros += parseInt(data[i]["total"]);
                          if($('#cmbGraficaID').val() == 1){
                            intSmooth = true;
                            if(totalMax < data[i]["total"]) 
                              totalMax = parseInt(data[i]["total"]);
                            currYear.push([data[i]["fecha"],data[i]["total"]]);
                          }else { //grafica exponecial
                            intSmooth = false;
                            totalMax = totalMax + parseInt(data[i]["total"]);
                            currYear.push([data[i]["fecha"],totalMax]);
                          }
                        }  
                      }
  ...
  function generar_grafico(){
            plot1 = $.jqplot("chart1", [currYear], {
                ...
                series:[
                    {label:intTotalRegistros+' Accesos'},
                ],
                grid: {
