<form id="frmOrdensServicio" action="#" method="post" onsubmit="return(false)" style="margin-bottom:5px;">
          ...
          <div class="btn-group" style="float:left;padding-top:3px;padding-right:10px">
            <button class="btn" tabindex="-1" style="float:left;" onclick="fnShowBitacora('#txtOrdenServicioID','ordenes_servicio');"><i class="icon-calendar"></i> Historial</button>
          </div>
          ...
          <div id="btnGuardar" class="btn-group" style="float:right;padding-right:10px;padding-top:3px;">
          ...
          <div id="btnSolucionar" class="btn-group" style="float:right;padding-right:10px;padding-top:3px;display:none;">
          ...
          <div id="divCerrarOrden" style="display:none;margin-top:0px;">
    ...
    <div id="myModalSeguimiento" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="top:5%; margin-left:5%; width:775px; left:15%;" >
      ...
      <div class="modal-footer">
              ...
              <button class="btn" tabindex="-1" style="float:left;" onclick="fnShowBitacora('#txtOrdenServicioID','ordenes_servicio_seguimiento');"><i class="icon-calendar"></i> Historial</button>
      </div>
    </div> 
    ...
    <div id="myModalMaterial" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="top:5%; margin-left:5%; width:615px; left:20%;" >
      ...
      <div class="modal-footer">
              ...
              <button class="btn" tabindex="-1" style="float:left;" onclick="fnShowBitacora('#txtOrdenServicioID','ordenes_servicio_material');"><i class="icon-calendar"></i> Historial</button>
      </div>
    </div> 
