...
<br>
	...
	<div id="myModal_Tarjetas" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="top:10%; width:1000px; left:30%;" >
		...
		<div class="modal-body" id="modal-bodyMC" style="height:100%; overflow-y:scroll;">
			<form name="frmTarjetas" id="frmTarjetas"  action="../imprimirContrato/vistas/contratoMC.php" method="post" autocomplete="off">
						...
						<div style="margin-bottom:12px;">
							<div style="display:inline-block; padding-right:17px;">
							  ...
							  <div class="input-prepend">
							  	...
							  	<input style="width:80px;text-align:right;" id="txtDescuento_Tarjetas" name="txtDescuento_Tarjetas" type="text" value="0.00" tabindex="8">
<div style="display:inline-block;"><button type="button" id="btnTarjeta6" name="btnTarjeta6" style="margin-bottom:7px;margin-left:6px" onclick="myFunction6()"><img align="center" width="24px" height="24px" src="../imagenes/asignar.png"></button></div>
							...
							<div style="display:inline-block; padding-right:17px;">
							  ...
							  <div class="input-prepend">
							  	...
							  	<input style="color:red; font-size:20px; font-weight: bold;width:80px;text-align:right;" id="txtTotal_Tarjetas" name="txtTotal_Tarjetas" type="text" value="0.00" tabindex="8">
							  </div>
							</div>
							<div style="display:inline-block; padding-right:17px;">
							  ...
							  <div class="input-prepend">
							  	...
							  	<input style="width:30px;text-align:right;" id="txtIva" name="txtIva" type="text" value="0.00" tabindex="8">
<div style="display:inline-block;"><button type="button" id="btnIVA7" name="btnIVA7" style="margin-bottom:7px;margin-left:6px" onclick="myFunction7()"><img align="center" width="24px" height="24px" src="../imagenes/validarIva.png"></button></div>
						...
						<button class="btn btn-primary" tabindex="11" style="float:right;margin-right:10px;" type="submit" onclick="fnGuardar12()"><i class="icon-hdd icon-white"></i> Guardar</button>
...
var total = parseFloat($("#txtPrecio_Tarjetas").val()) + parseFloat($("#txtPrecio_Tarjetas2").val()) + parseFloat($("#txtPrecio_Tarjetas3").val()) + parseFloat($("#txtPrecio_Tarjetas4").val()) + parseFloat($("#txtPrecio_Tarjetas5").val());
...
//---------- Funciones para la Busqueda
  ...
  function paginacion_tarjetas() {
    ...
    if(bolPagina)
    $.post('procesos/asignaciontarjetasMC/paginacion',
...
$('#txtComprador_Tarjetas').val('');
  ...
  function fnEditar(id){
  	$.post('procesos/asignaciontarjetasMC/editar',
		          { intAsignacionID: id
		          },
		          function(data) {
  ...
  function fnGuardar(){
    if(fnValidar()) {
      $.post('procesos/asignaciontarjetasMC/guardar',
...
var usuarioID= '<?php echo $usuarioID; ?>';
    ...
    //-----------------------------------------------------------------------
    $.ajax({                           
      url: '../guardarAsignacionMC.php',                  //the script to call to get data          
      data: "intAsignacionID="+intAsignacionID+"&intTarjetaID="+intTarjetaID+"&intTarjetaID2="+intTarjetaID2+"&intTarjetaID3="+intTarjetaID3+"&intTarjetaID4="+intTarjetaID4+"&intTarjetaID5="+intTarjetaID5+"&numeroSerie="+numeroSerie+"&numeroSerie2="+numeroSerie2+"&numeroSerie3="+numeroSerie3+"&numeroSerie4="+numeroSerie4+"&numeroSerie5="+numeroSerie5+"&strResidenteID="+strResidenteID+"&strCompradorID="+strCompradorID+"&bolNombreComprador="+bolNombreComprador+"&strFecha="+strFecha+"&strFechaVencimiento="+strFechaVencimiento+"&intTipoLecturaID="+intTipoLecturaID+"&strLecturaEPC="+strLecturaEPC+"&strFolioContrato="+strFolioContrato+"&dblPrecio="+dblPrecio+"&descuento="+descuento+"&IVA="+IVA+"&bolUtilizoSeguro="+bolUtilizoSeguro+"&bolUtilizoSeguro2="+bolUtilizoSeguro2+"&bolUtilizoSeguro3="+bolUtilizoSeguro3+"&bolUtilizoSeguro4="+bolUtilizoSeguro4+"&bolUtilizoSeguro5="+bolUtilizoSeguro5+"&precioTarjeta="+precioTarjeta+"&precioTarjeta2="+precioTarjeta2+"&precioTarjeta3="+precioTarjeta3+"&precioTarjeta4="+precioTarjeta4+"&precioTarjeta5="+precioTarjeta5+"&intEstatusID="+intEstatusID+"&usuarioID="+usuarioID,                        //you can insert url argumnets here to pass to api.php
                       type: "post",                //for example "id=5&parent=6"
      dataType: 'json',                //data format      
      success: function(data)          //on recieve of reply
      {
  ...
  function fnCambiarEstadoTarjetas(id,estado){
      $.post('procesos/asignaciontarjetasMC/cambiar_estado',
                  { intAsignacionID: id,
                    intEstatusID: estado
                  },
                  function(data) {
   ...
   function fnLiberarTarjeta(id,estado,tarjeta_id){
      $.post('procesos/asignaciontarjetasMC/liberar_tarjeta',
                  { intAsignacionID: id,
                    intEstatusID: estado,
  ...
  function cmbPrivada_set() {
    $.post('catalogos/privadas/opcionesMC',
                  {},
                  function(data) {
                    $('#cmbPrivadaID').empty();
  ...
  $( document ).ready(function() {
  	  $("#txtLectura_Tarjetas").autocomplete("catalogos/tarjetas/autocompleteMC", 
        { minChars:1,matchSubset:1,matchContains:1,cacheLength:8,onItemSelect:null,selectOnly:0,remoteDataType:"json"} 
      );
$("#txtLectura_Tarjetas2").autocomplete("catalogos/tarjetas/autocompleteMC", 
        { minChars:1,matchSubset:1,matchContains:1,cacheLength:8,onItemSelect:null,selectOnly:0,remoteDataType:"json"} 
      );
$("#txtLectura_Tarjetas3").autocomplete("catalogos/tarjetas/autocompleteMC", 
        { minChars:1,matchSubset:1,matchContains:1,cacheLength:8,onItemSelect:null,selectOnly:0,remoteDataType:"json"} 
      );
$("#txtLectura_Tarjetas4").autocomplete("catalogos/tarjetas/autocompleteMC", 
        { minChars:1,matchSubset:1,matchContains:1,cacheLength:8,onItemSelect:null,selectOnly:0,remoteDataType:"json"} 
      );
$("#txtLectura_Tarjetas5").autocomplete("catalogos/tarjetas/autocompleteMC", 
        { minChars:1,matchSubset:1,matchContains:1,cacheLength:8,onItemSelect:null,selectOnly:0,remoteDataType:"json"} 
      );
