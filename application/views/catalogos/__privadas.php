...
<div id="myModalRelay" class="modal hide fade" tabindex="0" role="dialog" aria-labelledby="myModalRelayLabel" aria-hidden="true" style="width: 550px;">
  ...
  <div class="modal-footer">
    <button class="btn"  onclick="fnCerrarModalRelay();" tabindex="23">Cancelar</button>
    <button id="btnGuardarRelays" class="btn btn-primary" tabindex="22" onclick="fnGuardarRelay();"><i class="icon-hdd icon-white"></i> Guardar</button>
  </div>
</div>
...
//---- Script para el Modal
     ...
     $('#myModal').on('hidden', function () {
        ...
        fnNuevo();
        $('#txtBusqueda').focus();
        //Agregar clase active para activar la pestaña 1 del contenedor de tabs
        $("#liTab1").addClass("active");
        //Remover clase active para desactivar las pestañas 2 y 3 del contenedor de tabs
