...
<div id="myModal" class="modal hide fade" tabindex="0" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width: 550px;">
  ...
  <div class="modal-body" style="padding-bottom:5px;">
	  <form name="frmPrivadas" id="frmPrivadas" action="#" method="post" onsubmit="return(false)" autocomplete="off" style="margin-bottom:5px;">
        ...
        <input id="txtDescripcionAnterior" type="hidden" value="">
        ...
        <div style="display:inline-block; padding-right:115px;">
          <label for="txtPrecios"><h5>Precio Vehicular</h5></label>
          <div class="input-prepend">
             <span class="add-on">$</span>
             <input style="width:80px;text-align:right;" id="txtPrecioVehicular" type="text" value="0.00" onblur="fnFormato(this,2);" tabindex="13">
          </div>
        </div>
        <div style="display:inline-block;">
<label for="txtPrecios2"><h5 style="margin-left:-70px;">Precio Peatonal</h5></label>
          <div class="input-prepend" style="margin-left:-70px;">
             <span class="add-on">$</span>
             <input style="width:80px;text-align:right;" id="txtPrecioPeatonal" type="text" value="0.00" onblur="fnFormato(this,2);" tabindex="14">
          </div>
        </div>
        <div style="display:inline-block;">
<label for="txtPrecios3"><h5 style="margin-left:40px;">Precio Mensualidad</h5></label>
          <div class="input-prepend" style="margin-left:40px;">
             <span class="add-on">$</span>
             <input style="width:80px;text-align:right;" id="txtPrecioMensualidad" type="text" value="0.00" onblur="fnFormato(this,2);" tabindex="14">
          </div>
        </div>
        </div>
			<div>
      ...
      <div style="display:inline-block; vertical-align: top; margin-top:15px;">
        ...
        <div  class="tabbable"> <!-- Only required for left/right tabs -->
          <ul  class="nav nav-tabs" style="margin-bottom: 5px;">
            ...
            <li id="liTab4" ><a href="#tabVideo1" data-toggle="tab" tabindex="14">VIDEO1  <button class="btn btn-mini" type="button" ><i class="icon-refresh"></i></button></a></li>
            <li id="liTab5" ><a href="#tabVideo2" data-toggle="tab" tabindex="14">VIDEO2  <button class="btn btn-mini" type="button"><i class="icon-refresh"></i></button></a></li>
            <li id="liTab6" ><a href="#tabVideo3" data-toggle="tab" tabindex="14">VIDEO3 <button class="btn btn-mini" type="button"><i class="icon-refresh"></i></button></a></li>
          </ul>
          <!-- TAB para DNS1 -->
          <div    class="tab-content" style="width:500px">
            <div class="tab-pane active" id="tabDNS1">
               <div style="display: inline-block; margin-right:15px;">
                ...
                <input class="span5" id="txtDNS1" type="text" placeholder="Ingresa DNS" tabindex="15" maxlength ="100">
               </div>
                &nbsp;&nbsp;&nbsp;
               <div style="display: inline-block;">
                <label for="txtPuerto1">Puerto</label>
                <input style='width:65px;' id="txtPuerto1" type="text" placeholder="Ingresa Puerto" tabindex="16" maxlength ="5">
               </div>
               <div  style="display: inline-block; ">
                <label for="txtAlias1">Alias</label>
                <input class="span5" id="txtAlias1" type="text" placeholder="Ingresa Alias" tabindex="17" maxlength ="100">
                     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               ...
               <div style="display: inline-block; margin-right:15px;">
                <label for="cmbTipoTarjeta1">Tipo de Tarjeta</label>
                 <select id="cmbTipoTarjeta1" class="span2" tabindex="19" >
               ...
               <div style="display: inline-block;">
                ...
                <input style='width:165%;'  id="txtContrasena1" type="password" placeholder="Ingresa Contraseña" tabindex="19" maxlength ="100">
               </div>
            ...
            <div class="tab-pane" id="tabDNS2">
              <div style="display: inline-block; margin-right:15px;">
                ...
                <input class="span5" id="txtDNS2" type="text" placeholder="Ingresa DNS" tabindex="15" maxlength ="100">
              </div>
               &nbsp;&nbsp;&nbsp;
               <div style="display: inline-block;">
                <label for="txtPuerto2">Puerto</label>
                <input style='width:65px;' id="txtPuerto2" type="text" placeholder="Ingresa Puerto" tabindex="16" maxlength ="5">
               </div>
               <div  style="display: inline-block; ">
                <label for="txtAlias2">Alias</label>
                <input class="span5" id="txtAlias2" type="text" placeholder="Ingresa Alias" tabindex="17" maxlength ="100">
                     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               ...
               <div style="display: inline-block; margin-right:15px;">
                <label for="cmbTipoTarjeta2">Tipo de Tarjeta</label>
                 <select id="cmbTipoTarjeta2" class="span2" tabindex="19" >
                    <option value="Tarjeta 1">Tarjeta 1</option>
                    <option value="Tarjeta 2">Tarjeta 2</option>
                  </select>
               </div>
               ...
               <div style="display: inline-block;">
                ...
                <input style='width:165%;'  id="txtContrasena2" type="password" placeholder="Ingresa Contraseña" tabindex="19" maxlength ="100">
               </div>
            ...
            <div class="tab-pane" id="tabDNS3">
              <div style="display: inline-block; margin-right:15px;">
                ...
                <input class="span5" id="txtDNS3" type="text" placeholder="Ingresa DNS" tabindex="15" maxlength ="100">
              </div>
               &nbsp;&nbsp;&nbsp;
               <div style="display: inline-block;">
                <label for="txtPuerto3">Puerto</label>
                <input style='width:65px;' id="txtPuerto3" type="text" placeholder="Ingresa Puerto" tabindex="16" maxlength ="5">
               </div>
               <div  style="display: inline-block; ">
                <label for="txtAlias3">Alias</label>
                <input class="span5" id="txtAlias3" type="text" placeholder="Ingresa Alias" tabindex="17" maxlength ="100">
                     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <div style="display: inline-block; margin-right:15px;">
                <label for="cmbTipoTarjeta3">Tipo de Tarjeta</label>
                 <select id="cmbTipoTarjeta3" class="span2" tabindex="19" >
                    <option value="Tarjeta 1">Tarjeta 1</option>
                    <option value="Tarjeta 2">Tarjeta 2</option>
                  </select>
               </div>
                &nbsp;&nbsp;&nbsp;
                <div style="display: inline-block; margin-right:15px;">
                    <label for="txtContrasena3">Contraseña</label>
                    <input style='width:165%;'  id="txtContrasena3" type="password" placeholder="Ingresa Contraseña" tabindex="19" maxlength ="100">
                </div>
            ...
            <!-- Paginación TAB'S DNS -->
            <div  id="divPaginacionRelays" style="dysplay: inline-block;">
            ...
            <!-- TAB para Video 1 -->
            <div class="tab-pane" id="tabVideo1">
              <div style="display: inline-block; margin-right:15px;">
                <!-- Campo oculto que contiene la descripción del video anterior (se utiliza para evitar duplicación de video por privada) -->
                <input type="hidden" id="txtVideo1Anterior" name="strVideo1Anterior" value=""> 
                <label for="txtVideo1">Video</label>
                <input class="span5" id="txtVideo1" type="text" placeholder="Ingresa Video" tabindex="15" maxlength ="100">
              </div>
              <div style="display: inline-block; margin-right:15px;">
                <label for="txtAliasVideo1">Alias</label>
                <input class="span5" id="txtAliasVideo1" type="text" placeholder="Ingresa Alias" tabindex="16" maxlength ="100">
              </div>
            </div>  <!-- Cierre para TAB de Video2 -->
            <!-- TAB para Video 2 -->
            <div class="tab-pane" id="tabVideo2">
              <div style="display: inline-block; margin-right:15px;">
                <!-- Campo oculto que contiene la descripción del video anterior (se utiliza para evitar duplicación de video por privada) -->
                <input type="hidden" id="txtVideo2Anterior" name="strVideo2Anterior" value=""> 
                <label for="txtVideo2">Video</label>
                <input class="span5" id="txtVideo2" type="text" placeholder="Ingresa Video" tabindex="15" maxlength ="100">
              </div>
              <div style="display: inline-block; margin-right:15px;">
                <label for="txtAliasVideo2">Alias</label>
                <input class="span5" id="txtAliasVideo2" type="text" placeholder="Ingresa Alias" tabindex="16" maxlength ="100">
              </div>
            </div>  <!-- Cierre para TAB de Video3 -->
            <!-- TAB para Video 3 -->
            <div class="tab-pane" id="tabVideo3">
              <div style="display: inline-block; margin-right:15px;">
                <!-- Campo oculto que contiene la descripción del video anterior (se utiliza para evitar duplicación de video por privada) -->
                <input type="hidden" id="txtVideo3Anterior" name="strVideo3Anterior" value=""> 
                <label for="txtVideo3">Video</label>
                <input class="span5" id="txtVideo3" type="text" placeholder="Ingresa Video" tabindex="15" maxlength ="100">
              </div>
              <div style="display: inline-block; margin-right:15px;">
                <label for="txtAliasVideo3">Alias</label>
                <input class="span5" id="txtAliasVideo3" type="text" placeholder="Ingresa Alias" tabindex="16" maxlength ="100">
              </div>
            </div>  <!-- Cierre para TAB de Video2 -->

          
          </div><!-- CIERRE DE CONTENEDOR TAB para DNS´S y VIDEOS -->
        </div>
      </div>
		</form>
  </div>
...
<div id="myModalRelay" class="modal hide fade" tabindex="0" role="dialog" aria-labelledby="myModalRelayLabel" aria-hidden="true" style="width: 550px;">
  ...
  <div class="modal-body" style="padding-bottom:5px;">
    <form name="frmRelayPrivadas" id="frmRelayPrivadas" action="#" method="post" onsubmit="return(false)" autocomplete="off" style="margin-bottom:5px;">
          ...
          <!-- Campo oculto que contiene la el tipo de tarjeta del dns seleccionado -->
          <input type="hidden" id="txtTipoTarjeta" name="strTipoTarjeta" value="">
           <!-- Campo oculto que contiene la la contraseña de la tarjeta 2 del dns seleccionado -->
          <input type="hidden" id="txtContrasena" name="strContrasena" value="">
         ...
         <div style="display: inline-block; margin-right:15px;">
          ...
          <input class="span6" id="txtRelays" type="text" placeholder="Ingresa Relay's,si es mas de uno separarlos con una coma '1,5'" style="display: inline-block;" tabindex="20" maxlength="100">
        </div>
...
//--------- Funciones para el Modal
  function fnNuevo (){
    ...
    if($('#txtPrivadaID').val()=="")
    {
      $('#frmPrivadas')[0].reset();
      $('#txtPrivadaID').val('');
      $('#txtDescripcionAnterior').val('');
      $('#txtVideo1Anterior').val('');
      $('#txtVideo2Anterior').val('');
      $('#txtVideo3Anterior').val('');
      $('#txtDNS1Anterior').val('');
      $('#txtDNS2Anterior').val('');
      $('#txtDNS3Anterior').val('');
    ...
    if(fnValidar()) {
      $.post('catalogos/privadas/guardar',
                  { intPrivadaID: $('#txtPrivadaID').val(), 
                    ...
                    intPrecioVehicular: $('#txtPrecioVehicular').val(),
                    intPrecioPeatonal: $('#txtPrecioPeatonal').val(),
                    intPrecioMensualidad: $('#txtPrecioMensualidad').val(),
                    ...
                    strTipoTarjeta1:$('#cmbTipoTarjeta1').val(),
                    strContrasena1:$('#txtContrasena1').val(),
                    strDNS2:$('#txtDNS2').val(),
                    strPuerto2:$('#txtPuerto2').val(),
                    strAlias2:$('#txtAlias2').val(),
                    strTipoTarjeta2:$('#cmbTipoTarjeta2').val(),
                    strContrasena2:$('#txtContrasena2').val(),
                    strDNS3:$('#txtDNS3').val(),
                    strPuerto3:$('#txtPuerto3').val(),
                    strAlias3:$('#txtAlias3').val(),
                    strTipoTarjeta3:$('#cmbTipoTarjeta3').val(),
                    strContrasena3:$('#txtContrasena3').val(),
                    strVideo1:$('#txtVideo1').val(),
                    strAliasVideo1:$('#txtAliasVideo1').val(),
                    strVideo2:$('#txtVideo2').val(),
                    strAliasVideo2:$('#txtAliasVideo2').val(),
                    strVideo3:$('#txtVideo3').val(),
                    strAliasVideo3:$('#txtAliasVideo3').val(),
...
$('#txtPrecioVehicular').val(data.row.precio_vehicular);
$('#txtPrecioPeatonal').val(data.row.precio_peatonal);
$('#txtPrecioMensualidad').val(data.row.precio_mensualidad);
                      ...
                      $('#cmbTipoTarjeta1').val(data.row.tipo_tarjeta1);
                      $('#txtContrasena1').val(data.row.contrasena_1);
                       //Habilitar caja de texto cuando la contraseña sea diferente de cadena vacia
                      if($('#txtContrasena1').val()!="")
                      {
                        $("#txtContrasena1" ).removeAttr('disabled');
                      }
                      //DNS2
                      $('#txtDNS2').val(data.row.dns_2);
                      $('#txtPuerto2').val(data.row.puerto_2);
                      $('#txtAlias2').val(data.row.alias_2);
                      $('#cmbTipoTarjeta2').val(data.row.tipo_tarjeta2);
                      $('#txtContrasena2').val(data.row.contrasena_2);
                      //Habilitar caja de texto cuando la contraseña sea diferente de cadena vacia
                      if($('#txtContrasena2').val()!="")
                      {
                          $("#txtContrasena2" ).removeAttr('disabled');
                      }
                      //DNS3
                      $('#txtDNS3').val(data.row.dns_3);
                      $('#txtPuerto3').val(data.row.puerto_3);
                      $('#txtAlias3').val(data.row.alias_3);
                      $('#cmbTipoTarjeta3').val(data.row.tipo_tarjeta3);
                      $('#txtContrasena3').val(data.row.contrasena_3);
                      //Habilitar caja de texto cuando la contraseña sea diferente de cadena vacia
                      if($('#txtContrasena3').val()!="")
                      {
                         $("#txtContrasena3" ).removeAttr('disabled');

                      }
                      //Recuperar valor de los videos
                      //Video1
                      $('#txtVideo1').val(data.row.video_1);
                      $('#txtAliasVideo1').val(data.row.alias_video1);
                      //Video2
                      $('#txtVideo2').val(data.row.video_2);
                      $('#txtAliasVideo2').val(data.row.alias_video2);
                      //Video3
                      $('#txtVideo3').val(data.row.video_3);
                      $('#txtAliasVideo3').val(data.row.alias_video3);
                      
                      //Recuperar valores para validación (evitar duplicación)
                      $('#txtDescripcionAnterior').val(data.row.descripcion);
                      $('#txtDNS1Anterior').val(data.row.dns_1);
                      $('#txtDNS2Anterior').val(data.row.dns_2);
                      $('#txtDNS3Anterior').val(data.row.dns_3);
                      $('#txtVideo1Anterior').val(data.row.video_1);
                      $('#txtVideo2Anterior').val(data.row.video_2);
                      $('#txtVideo3Anterior').val(data.row.video_3);
    ...
    if(fnValidar()) {
      $.post('catalogos/privadas/modificarDNSS',
                  { 
                    ...
                    strTipoTarjeta: $("#txtTipoTarjeta").val(),
 ...
 //Función que se utiliza para validar la url 
  ...
  //Función que se utiliza para validar que el video no exista en la privada
  function fnValidaVideo(descripcion,strCajaID) {
    //Recuperar id de la caja y hacer enfoque en caso de que el video exista
     var focusElementId = strCajaID;
     //Caja de texto
     var textBox = document.getElementById(focusElementId);
     //Realizar consulta para saber si existen coincidencias, y poder evitar duplicidad
     $.post('catalogos/privadas/checkExistenciaVideo',
                  { intPrivadaID: $('#txtPrivadaID').val(),
                    strVideo: descripcion,
                  },
                  function(data) {
                    //Recuperar valor de resultado 0(TRUE)
                    // --Existe video en la privada Y 1(FALSE) NO existe video en la privada
                    //Si el resultado es cero, significa que ya existe dns en la privada
                    //mostrar mensaje al usuario
                    if(data.resultado == 0){
                       $('#divMensajes').html(data.mensajes);
 ...
 */
 ...
 //Función que se utiliza para guardar los datos del relay del dns de la privada
  ...
  $( document ).ready(function() {
   var strDNS='';
   var strVideo='';
    //Llamar metodo fnValidaURL(1)  cuando se pierda el enfoque de la caja de texto
    $("#txtDNS1").focusout(function(e){
     ...
     //Llamar metodo fnValidaURL(2)  cuando se pierda el enfoque de la caja de texto
    $("#txtDNS2").focusout(function(e){
     ...
     //Llamar metodo fnValidaURL(3) cuando se pierda el enfoque de la caja de texto
    ...
    //Mostrar el campo contraseña en caso de que el tipo de tarjeta del DNS1 sea la número 2
    $("#cmbTipoTarjeta1").change(function() {
        if($("#cmbTipoTarjeta1").val()=='Tarjeta 2')
        {
           //Habilitar caja de texto contraseña
           $("#txtContrasena1").removeAttr('disabled');
        }
        else
    ...
    //Mostrar el campo contraseña en caso de que el tipo de tarjeta del DNS2 sea la número 2
    $("#cmbTipoTarjeta2").change(function() {
        if($("#cmbTipoTarjeta2").val()=='Tarjeta 2')
        {
           //Habilitar caja de texto contraseña
           $("#txtContrasena2").removeAttr('disabled');
        }
        ...
        {   //Deshabilitar caja de texto
            $("#txtContrasena2" ).attr('disabled','disabled');
            //Limpiar contenido de la caja de texto
            $("#txtContrasena2" ).val('');
        }
    });

    //Mostrar el campo contraseña en caso de que el tipo de tarjeta del DNS3 sea la número 2
    $("#cmbTipoTarjeta3").change(function() {
        if($("#cmbTipoTarjeta3").val()=='Tarjeta 2')
        {
           //Habilitar caja de texto contraseña
           $("#txtContrasena3").removeAttr('disabled');
        }
        ...
        {   //Deshabilitar caja de texto
            $("#txtContrasena3" ).attr('disabled','disabled');
            //Limpiar contenido de la caja de texto
            $("#txtContrasena3" ).val('');
        }
    });

    //Llamar metodo fnValidaVideo(1)  cuando se pierda el enfoque de la caja de texto
    $("#txtVideo1").focusout(function(e){
         strVideo=$("#txtVideo1").val();
          if (strVideo.length >= 3) {
               //Validar que la descripción del video1 sea correcta (este bien escrita)
               //fnValidaVideo(strVideo, 'txtVideo1');
               //Si el video1 es diferente al anterior, validar video para evitar (duplicidad)
                if(strVideo!= $("#txtVideo1Anterior").val())
                {
                  //Validar que la descripción del video1 no exista en la privada
                 //y así evitar duplicación
                  fnValidaVideo(strVideo, 'txtVideo1');
                }
          }
    ...
    //Llamar metodo fnValidaVideo(2)  cuando se pierda el enfoque de la caja de texto 
    $("#txtVideo2").focusout(function(e){
         strVideo=$("#txtVideo2").val();
          if (strVideo.length >= 3) {
               //Validar que la descripción del video2 sea correcta (este bien escrita)
               //fnValidaVideo(strVideo, 'txtVideo2');
               //Si el video1 es diferente al anterior, validar video para evitar (duplicidad)
                if(strVideo!= $("#txtVideo2Anterior").val())
                {
                  //Validar que la descripción del video2 no exista en la privada
                 //y así evitar duplicación
                  fnValidaVideo(strVideo, 'txtVideo2');
                }
          }
    ...
    //Llamar metodo fnValidaVideo(3)  cuando se pierda el enfoque de la caja de texto 
    $("#txtVideo3").focusout(function(e){
         strVideo=$("#txtVideo3").val();
          if (strVideo.length >= 3) {
               //Validar que la descripción del video3 sea correcta (este bien escrita)
               //fnValidaVideo(strVideo, 'txtVideo3');
               //Si el video1 es diferente al anterior, validar video para evitar (duplicidad)
                if(strVideo!= $("#txtVideo3Anterior").val())
                {
                  //Validar que la descripción del video3 no exista en la privada
                 //y así evitar duplicación
                  fnValidaVideo(strVideo, 'txtVideo3');
                }
          }
...
//---- Script para la Busqueda
     ...
     $("#liTab1").click(function(event){
        ...
        $("#txtDNS1").focus();
        //Quitar al div la clase no-mostrar (mostrar div con la paginación de relays)
        $("#divPaginacionRelays").removeClass("no-mostrar");
    });
    ...
    //Al dar clic en el tab video 1 
    $("#liTab4").click(function(event){
        //Agregar al div la clase no-mostrar (evitar mostrar div con la paginación de relays)
        $("#divPaginacionRelays").addClass("no-mostrar");
     
    });

    //Al dar clic en el tab video 2
    $("#liTab5").click(function(event){
        //Agregar al div la clase no-mostrar (evitar mostrar div con la paginación de relays)
        $("#divPaginacionRelays").addClass("no-mostrar");
    ...
    $("#liTab6").click(function(event){
     ...
     //Funciones de los controles del modal Relay
      ...
      $("#btnAgregarRelayDNS1").click(function(event){
        ...
        var strTipoTarjeta=$("#cmbTipoTarjeta1").val();
        var strContrasena=$("#txtContrasena1").val();
        //Si el dns es diferente de vacio abrir modal para agregar relays
         if(strDNS !="" && strAlias !="" && strPuerto !="" )
         {
           ...
           //tipo de tarjeta del dns1
           $("#txtTipoTarjeta").val(strTipoTarjeta);
           //Contraseña del tipo de tarjeta 2  del dns1
           $("#txtContrasena").val(strContrasena);
      ...
      $("#btnAgregarRelayDNS2").click(function(event){
        ...
        var strTipoTarjeta2=$("#cmbTipoTarjeta2").val();
        var strContrasena2=$("#txtContrasena2").val();
        //Si el dns es diferente de vacio abrir modal para agregar relays
         if(strDNS2!=""  && strAlias2 !="" && strPuerto2 !="")
         {
           ...
           //tipo de tarjeta del dns2
           $("#txtTipoTarjeta").val(strTipoTarjeta2);
           //Contraseña del tipo de tarjeta 2  del dns2
           $("#txtContrasena").val(strContrasena2);
           //Hacer llamado a la función para modificar los datos del DNS seleccionado
           fnModificarDNS();
      ...
      $("#btnAgregarRelayDNS3").click(function(event){
         ...
         var strTipoTarjeta3=$("#cmbTipoTarjeta3").val();
         var strContrasena3=$("#txtContrasena3").val();
         //Si el dns es diferente de vacio abrir modal para agregar relays
         if(strDNS3!=""  && strAlias3 !="" && strPuerto3!="")
         {
           ...
           $("#txtAlias").val(strAlias3);
            //tipo de tarjeta del dns3
           $("#txtTipoTarjeta").val(strTipoTarjeta3);
           //Contraseña del tipo de tarjeta 2  del dns3
           $("#txtContrasena").val(strContrasena3);
           //Hacer llamado a la función para modificar los datos del DNS seleccionado
           fnModificarDNS();
