<form name="frmTarjetas" id="frmTarjetas" action="#" method="post" onsubmit="return(false)" autocomplete="off" style="margin-bottom:0px">
...
<div style="">
						<div style="width:90px;text-align:right;display:inline-block;">
							<strong id="numConsignacion">0</strong>
						</div> &nbsp; &nbsp; Consignación
					</div>
<div style="">
						<div style="width:90px;text-align:right;display:inline-block;">
							<strong id="numBajas">0</strong>
						</div> &nbsp; &nbsp; Bajas
					</div>
				</div>
				<button class="btn" tabindex="-1" style="margin-bottom:0px;margin-top:125px;" onclick="fnShowBitacora('#txtTarjetaID','tarjetas');"><i class="icon-calendar"></i> Historial</button>
			</div>
...
<form action='../importarTarjetas.php' method='post' enctype="multipart/form-data">
<h2>Importación de tarjetas para Oficina</h2>
   Seleccione el Archivo : <input type='file' name='sel_file' size='20'>
   <input type='submit' name='submit' value='Importar'>
  </form>
  <br><br>
  <form action='../importarTarjetasLinea.php' method='post' enctype="multipart/form-data">
<h2>Importación de Tarjetas para Venta en Línea</h2>
   Seleccione el Archivo : <input type='file' name='sel_file' size='20'>
   <input type='submit' name='submit' value='Importar'>
  </form>
...
$('#numConsignacion').html(data.total_consignacion);
$('#numBajas').html(data.total_bajas);
                    pagina = data.pagina;
                  }
                 ,
          'json');
