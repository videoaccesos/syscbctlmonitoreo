...
<form id="frmSearch" action="#" method="post" onsubmit="return(false)">
          ...
          <div class="btn-group" style="display:inline-block;float:right;padding-top:40px;">
		    ...
		    <button type="submit" class="btn btn-inverse" onclick="fnExportarResidenciasExcel()">
	...
	<div id="myModal_Residencias" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	  ...
	  <div class="modal-body">
		  <form name="frmResidencias" id="frmResidencias" action="#" method="post" onsubmit="return(false)" autocomplete="off" style="margin-bottom:0px;">
			...
			<label for="txtTel1_Residencias" style="width:315px;display:inline-block;">Tel&eacute;fono Fijo: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tel&eacute;fono Celular:</label> <label style="width:30px;display:inline;" for="txtInterfon">Clave Interfón</label>
			...
			<div class="input">
				...
				<input class="span2" id="txtInterfon" type="text" placeholder="Clave Interfón" tabindex="7" maxlength="5">
<br>
<label>Teléfono de Interfón:</label>
			<input style="margin-left:320px;" class="span2" id="txtTel_Interfon" type="text" placeholder="Ingrese Teléfono" tabindex="1">
...
<form name="valida_correo" method="POST" action="../valida_correo_API.php" target="_blank"><input class="span5" name="txtEmail_Residentes" id="txtEmail_Residentes" type="text" tabindex="16" placeholder="Ingresa Email"> <input id="validarCorreo" type="submit" value="Validar" style="background-color:green; color:white; border-radius:5px; padding:3px; margin-top:-11px; font-weight: bold;"></form>
...
//---------- Funciones para la Busqueda
  ...
  function fnExportarResidenciasExcel() 
  {
	var privada= $('#txtPrivada').val();
	var calleNoCasa= $('#txtBusqueda').val();
	var url= '../exportarResidenciasExcel.php?privada='+privada+'&calleNoCasa='+calleNoCasa;
	window.open(url);
    /*$.ajax({                           
      url: '../exportarResidenciasExcel.php',       
      data: "privada="+privada+"&calleNoCasa="+calleNoCasa,
                       type: "post",
      dataType: 'json',
...
strTelInterfon: $('#txtTel_Interfon').val(),
...
$('#txtTel_Interfon').val(data.row.telefono_interfon);
