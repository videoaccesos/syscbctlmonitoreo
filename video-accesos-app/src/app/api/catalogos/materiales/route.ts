...
export async function GET(request: NextRequest) {
  try {
    ...
    const allowedSortFields = ["codigo", "descripcion", "costo", "estatusId"];
    const sortByParam = searchParams.get("sortBy") || "codigo";
    const sortBy = allowedSortFields.includes(sortByParam) ? sortByParam : "codigo";
